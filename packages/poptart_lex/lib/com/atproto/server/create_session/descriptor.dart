...
final methodDescriptor =
    ...
    >(
      ...
      inputFromJson: (json) => const ServerCreateSessionInputConverter()
          .fromJson(json.cast<String, dynamic>()),
      inputToJson: const ServerCreateSessionInputConverter().toJson,
      outputFromJson: (json) => const ServerCreateSessionOutputConverter()
          .fromJson(json.cast<String, dynamic>()),
      outputToJson: const ServerCreateSessionOutputConverter().toJson,
      errors: const ['AccountTakedown', 'AuthFactorTokenRequired'],
    );

final comAtprotoServerCreateSession = methodDescriptor;
