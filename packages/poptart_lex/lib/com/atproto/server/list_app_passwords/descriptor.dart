...
final methodDescriptor =
    XRPCMethodDescriptor<EmptyData, EmptyData, ServerListAppPasswordsOutput>(
      nsid: NSID.parse('com.atproto.server.listAppPasswords'),
      kind: XRPCMethodKind.query,
      outputFromJson: (json) => const ServerListAppPasswordsOutputConverter()
...
final comAtprotoServerListAppPasswords = methodDescriptor;
