...
final appPasswordDescriptor = XRPCObjectDescriptor<AppPassword>(
  ...
  defName: 'appPassword',
  fromJson: (json) =>
      const AppPasswordConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const AppPasswordConverter().toJson,
  matches: AppPassword.validate,
);

final methodDescriptor =
    XRPCMethodDescriptor<EmptyData, ServerCreateAppPasswordInput, AppPassword>(
      nsid: NSID.parse('com.atproto.server.createAppPassword'),
      kind: XRPCMethodKind.procedure,
      inputFromJson: (json) => const ServerCreateAppPasswordInputConverter()
          .fromJson(json.cast<String, dynamic>()),
      inputToJson: const ServerCreateAppPasswordInputConverter().toJson,
      outputFromJson: (json) =>
          const AppPasswordConverter().fromJson(json.cast<String, dynamic>()),
...
final comAtprotoServerCreateAppPassword = methodDescriptor;
