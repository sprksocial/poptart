...
final commitDescriptor = XRPCObjectDescriptor<Commit>(
  ...
  defName: 'commit',
  fromJson: (json) =>
      const CommitConverter().fromJson(json.cast<String, dynamic>()),
...
final syncDescriptor = XRPCObjectDescriptor<Sync>(
  ...
  defName: 'sync',
  fromJson: (json) =>
      const SyncConverter().fromJson(json.cast<String, dynamic>()),
...
final identityDescriptor = XRPCObjectDescriptor<Identity>(
  ...
  defName: 'identity',
  fromJson: (json) =>
      const IdentityConverter().fromJson(json.cast<String, dynamic>()),
...
final accountDescriptor = XRPCObjectDescriptor<Account>(
  ...
  defName: 'account',
  fromJson: (json) =>
      const AccountConverter().fromJson(json.cast<String, dynamic>()),
...
final infoDescriptor = XRPCObjectDescriptor<Info>(
  ...
  defName: 'info',
  fromJson: (json) =>
      const InfoConverter().fromJson(json.cast<String, dynamic>()),
...
final repoOpDescriptor = XRPCObjectDescriptor<RepoOp>(
  ...
  defName: 'repoOp',
  fromJson: (json) =>
      const RepoOpConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const RepoOpConverter().toJson,
  matches: RepoOp.validate,
);

final methodDescriptor =
    XRPCMethodDescriptor<SyncSubscribeReposInput, EmptyData, Object>(
      nsid: NSID.parse('com.atproto.sync.subscribeRepos'),
      kind: XRPCMethodKind.subscription,
      parametersFromJson: (json) => const SyncSubscribeReposInputConverter()
...
final comAtprotoSyncSubscribeRepos = methodDescriptor;
