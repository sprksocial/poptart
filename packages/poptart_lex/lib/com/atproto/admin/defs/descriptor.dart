...
final statusAttrDescriptor = XRPCObjectDescriptor<StatusAttr>(
  ...
  defName: 'statusAttr',
  fromJson: (json) =>
      const StatusAttrConverter().fromJson(json.cast<String, dynamic>()),
...
final repoRefDescriptor = XRPCObjectDescriptor<RepoRef>(
  ...
  defName: 'repoRef',
  fromJson: (json) =>
      const RepoRefConverter().fromJson(json.cast<String, dynamic>()),
...
final repoBlobRefDescriptor = XRPCObjectDescriptor<RepoBlobRef>(
  ...
  defName: 'repoBlobRef',
  fromJson: (json) =>
      const RepoBlobRefConverter().fromJson(json.cast<String, dynamic>()),
...
final threatSignatureDescriptor = XRPCObjectDescriptor<ThreatSignature>(
  ...
  fromJson: (json) =>
      const ThreatSignatureConverter().fromJson(json.cast<String, dynamic>()),
