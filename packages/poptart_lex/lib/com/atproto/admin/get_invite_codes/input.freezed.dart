...
@AdminGetInviteCodesParametersSortConverter() AdminGetInviteCodesParametersSort? get sort; int get limit; String? get cursor; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
@AdminGetInviteCodesParametersSortConverter() AdminGetInviteCodesParametersSort? sort, int limit, String? cursor, Map<String, dynamic>? $unknown
});


$AdminGetInviteCodesParametersSortCopyWith<$Res>? get sort;
...
as AdminGetInviteCodesParametersSort?,limit: null == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
...
$AdminGetInviteCodesParametersSortCopyWith<$Res>? get sort {
  ...
  return $AdminGetInviteCodesParametersSortCopyWith<$Res>(_self.sort!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@AdminGetInviteCodesParametersSortConverter()  AdminGetInviteCodesParametersSort? sort,  int limit,  String? cursor,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminGetInviteCodesInput() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@AdminGetInviteCodesParametersSortConverter()  AdminGetInviteCodesParametersSort? sort,  int limit,  String? cursor,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _AdminGetInviteCodesInput():
return $default(_that.sort,_that.limit,_that.cursor,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@AdminGetInviteCodesParametersSortConverter()  AdminGetInviteCodesParametersSort? sort,  int limit,  String? cursor,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _AdminGetInviteCodesInput() when $default != null:
return $default(_that.sort,_that.limit,_that.cursor,_that.$unknown);case _:
  return null;
...
class _AdminGetInviteCodesInput implements AdminGetInviteCodesInput {
  const _AdminGetInviteCodesInput({@AdminGetInviteCodesParametersSortConverter() this.sort, this.limit = 100, this.cursor, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _AdminGetInviteCodesInput.fromJson(Map<String, dynamic> json) => _$AdminGetInviteCodesInputFromJson(json);

@override@AdminGetInviteCodesParametersSortConverter() final  AdminGetInviteCodesParametersSort? sort;
...
@override $AdminGetInviteCodesParametersSortCopyWith<$Res>? get sort;
