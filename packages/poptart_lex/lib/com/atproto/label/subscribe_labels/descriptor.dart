...
final labelsDescriptor = XRPCObjectDescriptor<Labels>(
  ...
  defName: 'labels',
  fromJson: (json) =>
      const LabelsConverter().fromJson(json.cast<String, dynamic>()),
...
final methodDescriptor =
    XRPCMethodDescriptor<LabelSubscribeLabelsInput, EmptyData, Object>(
      nsid: NSID.parse('com.atproto.label.subscribeLabels'),
      kind: XRPCMethodKind.subscription,
      parametersFromJson: (json) => const LabelSubscribeLabelsInputConverter()
...
final comAtprotoLabelSubscribeLabels = methodDescriptor;
