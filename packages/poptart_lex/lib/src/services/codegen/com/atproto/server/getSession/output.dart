...
abstract class ServerGetSessionOutput with _$ServerGetSessionOutput {
  static const knownProps = <String>['handle', 'did', 'didDoc', 'email', 'emailConfirmed', 'emailAuthFactor', 'active', 'status', ];
...
@ServerGetSessionStatusConverter() ServerGetSessionStatus? status,
  ...
  factory ServerGetSessionOutput.fromJson(Map<String, Object?> json) => _$ServerGetSessionOutputFromJson(json);
}
...
final class ServerGetSessionOutputConverter
  ...
  ServerGetSessionOutput fromJson(Map<String, dynamic> json) {
    return ServerGetSessionOutput.fromJson(translate(
      json,
      ServerGetSessionOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ServerGetSessionOutput object) => untranslate(
        object.toJson(),
      );
}
