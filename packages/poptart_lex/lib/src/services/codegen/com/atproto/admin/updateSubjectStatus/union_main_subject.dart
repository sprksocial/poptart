...
import '../../repo/strongRef/main.dart';
...
@freezed
sealed class UAdminUpdateSubjectStatusSubject with _$UAdminUpdateSubjectStatusSubject {
...
const factory UAdminUpdateSubjectStatusSubject.repoBlobRef({
  ...
  Map<String, dynamic> toJson() => const UAdminUpdateSubjectStatusSubjectConverter().toJson(this);
}

extension UAdminUpdateSubjectStatusSubjectExtension on UAdminUpdateSubjectStatusSubject {
...
bool get isRepoStrongRef => isA<UAdminUpdateSubjectStatusSubjectRepoStrongRef>(this);
bool get isNotRepoStrongRef => !isRepoStrongRef;
RepoStrongRef? get repoStrongRef => isRepoStrongRef ? data as RepoStrongRef : null;
bool get isRepoBlobRef => isA<UAdminUpdateSubjectStatusSubjectRepoBlobRef>(this);
...
final class UAdminUpdateSubjectStatusSubjectConverter implements JsonConverter<UAdminUpdateSubjectStatusSubject, Map<String, dynamic>> {
...
if (RepoBlobRef.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UAdminUpdateSubjectStatusSubject object) => object.when(
