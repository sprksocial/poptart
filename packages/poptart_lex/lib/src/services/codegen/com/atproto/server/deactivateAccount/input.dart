...
@freezed
abstract class ServerDeactivateAccountInput with _$ServerDeactivateAccountInput {
...
DateTime? deleteAfter,
  ...
  factory ServerDeactivateAccountInput.fromJson(Map<String, Object?> json) => _$ServerDeactivateAccountInputFromJson(json);
}

extension ServerDeactivateAccountInputExtension on ServerDeactivateAccountInput {
...
final class ServerDeactivateAccountInputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerDeactivateAccountInput object) => untranslate(
        object.toJson(),
      );
}
