...
@freezed
abstract class IdentitySignPlcOperationOutput with _$IdentitySignPlcOperationOutput {
  ...
  factory IdentitySignPlcOperationOutput.fromJson(Map<String, Object?> json) => _$IdentitySignPlcOperationOutputFromJson(json);
}



final class IdentitySignPlcOperationOutputConverter
    extends JsonConverter<IdentitySignPlcOperationOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(IdentitySignPlcOperationOutput object) => untranslate(
        object.toJson(),
      );
}
