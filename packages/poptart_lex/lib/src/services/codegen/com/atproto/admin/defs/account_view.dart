...
abstract class AccountView with _$AccountView {
  static const knownProps = <String>['did', 'handle', 'email', 'relatedRecords', 'indexedAt', 'invitedBy', 'invites', 'invitesDisabled', 'emailConfirmedAt', 'inviteNote', 'deactivatedAt', 'threatSignatures', ];
...
@ThreatSignatureConverter() List<ThreatSignature>? threatSignatures,
  ...
  factory AccountView.fromJson(Map<String, Object?> json) => _$AccountViewFromJson(json);
