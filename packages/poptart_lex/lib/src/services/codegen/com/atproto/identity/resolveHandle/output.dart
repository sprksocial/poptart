...
abstract class IdentityResolveHandleOutput with _$IdentityResolveHandleOutput {
  ...
  factory IdentityResolveHandleOutput.fromJson(Map<String, Object?> json) => _$IdentityResolveHandleOutputFromJson(json);
}
...
final class IdentityResolveHandleOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(IdentityResolveHandleOutput object) => untranslate(
        object.toJson(),
      );
}
