...
abstract class AdminSendEmailInput with _$AdminSendEmailInput {
  static const knownProps = <String>['recipientDid', 'content', 'subject', 'senderDid', 'comment', ];
...
String? comment,
  ...
  factory AdminSendEmailInput.fromJson(Map<String, Object?> json) => _$AdminSendEmailInputFromJson(json);
}
