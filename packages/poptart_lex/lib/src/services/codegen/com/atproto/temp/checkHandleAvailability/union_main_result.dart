...
@freezed
sealed class UTempCheckHandleAvailabilityResult with _$UTempCheckHandleAvailabilityResult {
...
const factory UTempCheckHandleAvailabilityResult.resultUnavailable({
  ...
  Map<String, dynamic> toJson() => const UTempCheckHandleAvailabilityResultConverter().toJson(this);
}

extension UTempCheckHandleAvailabilityResultExtension on UTempCheckHandleAvailabilityResult {
  bool get isResultAvailable => isA<UTempCheckHandleAvailabilityResultResultAvailable>(this);
bool get isNotResultAvailable => !isResultAvailable;
ResultAvailable? get resultAvailable => isResultAvailable ? data as ResultAvailable : null;
bool get isResultUnavailable => isA<UTempCheckHandleAvailabilityResultResultUnavailable>(this);
bool get isNotResultUnavailable => !isResultUnavailable;
ResultUnavailable? get resultUnavailable => isResultUnavailable ? data as ResultUnavailable : null;
...
final class UTempCheckHandleAvailabilityResultConverter implements JsonConverter<UTempCheckHandleAvailabilityResult, Map<String, dynamic>> {
...
if (ResultUnavailable.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UTempCheckHandleAvailabilityResult object) => object.when(
        resultAvailable: (data) => const ResultAvailableConverter().toJson(data),
resultUnavailable: (data) => const ResultUnavailableConverter().toJson(data),
