...
abstract class RepoListRecordsInput with _$RepoListRecordsInput {
  static const knownProps = <String>['repo', 'collection', 'limit', 'cursor', 'reverse', ];
...
bool? reverse,
  ...
  factory RepoListRecordsInput.fromJson(Map<String, Object?> json) => _$RepoListRecordsInputFromJson(json);
}
