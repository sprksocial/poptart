...
abstract class ResultAvailable with _$ResultAvailable {
  ...
  const factory ResultAvailable({
    @Default('com.atproto.temp.checkHandleAvailability#resultAvailable') String $type,
    
    Map<String, dynamic>? $unknown,
  }) = _ResultAvailable;

  factory ResultAvailable.fromJson(Map<String, Object?> json) => _$ResultAvailableFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'com.atproto.temp.checkHandleAvailability#resultAvailable'
;
}
