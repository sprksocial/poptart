...
@freezed
abstract class ServerCreateAppPasswordInput with _$ServerCreateAppPasswordInput {
...
bool? privileged,
  ...
  factory ServerCreateAppPasswordInput.fromJson(Map<String, Object?> json) => _$ServerCreateAppPasswordInputFromJson(json);
}

extension ServerCreateAppPasswordInputExtension on ServerCreateAppPasswordInput {
...
final class ServerCreateAppPasswordInputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerCreateAppPasswordInput object) => untranslate(
        object.toJson(),
      );
}
