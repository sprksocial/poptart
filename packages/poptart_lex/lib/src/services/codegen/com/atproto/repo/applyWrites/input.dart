...
abstract class RepoApplyWritesInput with _$RepoApplyWritesInput {
  static const knownProps = <String>['repo', 'validate', 'writes', 'swapCommit', ];
...
bool? validate,
@URepoApplyWritesWritesConverter() required List<URepoApplyWritesWrites> writes,
...
String? swapCommit,
  ...
  factory RepoApplyWritesInput.fromJson(Map<String, Object?> json) => _$RepoApplyWritesInputFromJson(json);
}
