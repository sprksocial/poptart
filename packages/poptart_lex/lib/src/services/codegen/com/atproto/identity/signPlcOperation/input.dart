...
@freezed
abstract class IdentitySignPlcOperationInput with _$IdentitySignPlcOperationInput {
  static const knownProps = <String>['token', 'rotationKeys', 'alsoKnownAs', 'verificationMethods', 'services', ];
...
Map<String, dynamic>? services,
  ...
  factory IdentitySignPlcOperationInput.fromJson(Map<String, Object?> json) => _$IdentitySignPlcOperationInputFromJson(json);
}

extension IdentitySignPlcOperationInputExtension on IdentitySignPlcOperationInput {
...
final class IdentitySignPlcOperationInputConverter
  ...
  @override
  Map<String, dynamic> toJson(IdentitySignPlcOperationInput object) => untranslate(
        object.toJson(),
      );
}
