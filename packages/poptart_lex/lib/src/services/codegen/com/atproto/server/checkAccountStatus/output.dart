...
@freezed
abstract class ServerCheckAccountStatusOutput with _$ServerCheckAccountStatusOutput {
  static const knownProps = <String>['activated', 'validDid', 'repoCommit', 'repoRev', 'repoBlocks', 'indexedRecords', 'privateStateValues', 'expectedBlobs', 'importedBlobs', ];
...
required int importedBlobs,
  ...
  factory ServerCheckAccountStatusOutput.fromJson(Map<String, Object?> json) => _$ServerCheckAccountStatusOutputFromJson(json);
}

extension ServerCheckAccountStatusOutputExtension on ServerCheckAccountStatusOutput {
...
final class ServerCheckAccountStatusOutputConverter
    extends JsonConverter<ServerCheckAccountStatusOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ServerCheckAccountStatusOutput object) => untranslate(
        object.toJson(),
      );
}
