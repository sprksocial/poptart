...
@freezed
abstract class ServerGetAccountInviteCodesInput with _$ServerGetAccountInviteCodesInput {
...
@Default(true) bool createAvailable,
  ...
  factory ServerGetAccountInviteCodesInput.fromJson(Map<String, Object?> json) => _$ServerGetAccountInviteCodesInputFromJson(json);
}

extension ServerGetAccountInviteCodesInputExtension on ServerGetAccountInviteCodesInput {
...
final class ServerGetAccountInviteCodesInputConverter
    extends JsonConverter<ServerGetAccountInviteCodesInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ServerGetAccountInviteCodesInput object) => untranslate(
        object.toJson(),
      );
}
