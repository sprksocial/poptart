...
abstract class ResultUnavailable with _$ResultUnavailable {
  ...
  const factory ResultUnavailable({
    @Default('com.atproto.temp.checkHandleAvailability#resultUnavailable') String $type,
    @SuggestionConverter() required List<Suggestion> suggestions,

    Map<String, dynamic>? $unknown,
  }) = _ResultUnavailable;

  factory ResultUnavailable.fromJson(Map<String, Object?> json) => _$ResultUnavailableFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'com.atproto.temp.checkHandleAvailability#resultUnavailable'
;
}
