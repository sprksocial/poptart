...
abstract class RepoListRecordsOutput with _$RepoListRecordsOutput {
  ...
  const factory RepoListRecordsOutput({
    String? cursor,
@RepoListRecordsRecordConverter() required List<RepoListRecordsRecord> records,

    Map<String, dynamic>? $unknown,
  }) = _RepoListRecordsOutput;

  factory RepoListRecordsOutput.fromJson(Map<String, Object?> json) => _$RepoListRecordsOutputFromJson(json);
}
