...
required String scope,
  ...
  factory TempDereferenceScopeOutput.fromJson(Map<String, Object?> json) => _$TempDereferenceScopeOutputFromJson(json);
}
...
final class TempDereferenceScopeOutputConverter
  ...
  TempDereferenceScopeOutput fromJson(Map<String, dynamic> json) {
    return TempDereferenceScopeOutput.fromJson(translate(
      json,
      TempDereferenceScopeOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(TempDereferenceScopeOutput object) => untranslate(
        object.toJson(),
      );
}
