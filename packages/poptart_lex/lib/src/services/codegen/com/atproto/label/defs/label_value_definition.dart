...
abstract class LabelValueDefinition with _$LabelValueDefinition {
  static const knownProps = <String>['identifier', 'severity', 'blurs', 'defaultSetting', 'adultOnly', 'locales', ];
...
@LabelValueDefinitionSeverityConverter() required LabelValueDefinitionSeverity severity,
/// What should this label hide in the UI, if applied? 'content' hides all of the target; 'media' hides the images/video/audio; 'none' hides nothing.
@LabelValueDefinitionBlursConverter() required LabelValueDefinitionBlurs blurs,
/// The default setting for this label.
@LabelValueDefinitionDefaultSettingConverter() LabelValueDefinitionDefaultSetting? defaultSetting,
/// Does the user need to have adult content enabled in order to configure this label?
bool? adultOnly,
@LabelValueDefinitionStringsConverter() required List<LabelValueDefinitionStrings> locales,

    Map<String, dynamic>? $unknown,
  }) = _LabelValueDefinition;

  factory LabelValueDefinition.fromJson(Map<String, Object?> json) => _$LabelValueDefinitionFromJson(json);
