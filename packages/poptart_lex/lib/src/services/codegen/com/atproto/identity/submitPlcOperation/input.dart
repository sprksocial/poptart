...
@freezed
abstract class IdentitySubmitPlcOperationInput with _$IdentitySubmitPlcOperationInput {
  ...
  factory IdentitySubmitPlcOperationInput.fromJson(Map<String, Object?> json) => _$IdentitySubmitPlcOperationInputFromJson(json);
}



final class IdentitySubmitPlcOperationInputConverter
    extends JsonConverter<IdentitySubmitPlcOperationInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(IdentitySubmitPlcOperationInput object) => untranslate(
        object.toJson(),
      );
}
