...
@freezed
sealed class UModerationCreateReportSubject with _$UModerationCreateReportSubject {
...
const factory UModerationCreateReportSubject.repoStrongRef({
  ...
  Map<String, dynamic> toJson() => const UModerationCreateReportSubjectConverter().toJson(this);
}

extension UModerationCreateReportSubjectExtension on UModerationCreateReportSubject {
...
bool get isRepoStrongRef => isA<UModerationCreateReportSubjectRepoStrongRef>(this);
...
final class UModerationCreateReportSubjectConverter implements JsonConverter<UModerationCreateReportSubject, Map<String, dynamic>> {
...
if (RepoStrongRef.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UModerationCreateReportSubject object) => object.when(
