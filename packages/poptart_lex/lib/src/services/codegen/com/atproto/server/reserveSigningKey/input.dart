...
@freezed
abstract class ServerReserveSigningKeyInput with _$ServerReserveSigningKeyInput {
...
String? did,
  ...
  factory ServerReserveSigningKeyInput.fromJson(Map<String, Object?> json) => _$ServerReserveSigningKeyInputFromJson(json);
}

extension ServerReserveSigningKeyInputExtension on ServerReserveSigningKeyInput {
...
final class ServerReserveSigningKeyInputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerReserveSigningKeyInput object) => untranslate(
        object.toJson(),
      );
}
