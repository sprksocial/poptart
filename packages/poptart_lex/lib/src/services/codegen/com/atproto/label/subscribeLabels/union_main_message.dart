...
const factory ULabelSubscribeLabelsMessage.info({
  ...
  Map<String, dynamic> toJson() => const ULabelSubscribeLabelsMessageConverter().toJson(this);
}

extension ULabelSubscribeLabelsMessageExtension on ULabelSubscribeLabelsMessage {
...
final class ULabelSubscribeLabelsMessageConverter implements JsonConverter<ULabelSubscribeLabelsMessage, Map<String, dynamic>> {
...
if (Info.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(ULabelSubscribeLabelsMessage object) => object.when(
