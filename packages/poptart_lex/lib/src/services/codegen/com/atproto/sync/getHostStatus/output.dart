...
abstract class SyncGetHostStatusOutput with _$SyncGetHostStatusOutput {
  static const knownProps = <String>['hostname', 'seq', 'accountCount', 'status', ];
...
@HostStatusConverter() HostStatus? status,
  ...
  factory SyncGetHostStatusOutput.fromJson(Map<String, Object?> json) => _$SyncGetHostStatusOutputFromJson(json);
}
