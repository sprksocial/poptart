...
abstract class AppPassword with _$AppPassword {
  static const knownProps = <String>['name', 'password', 'createdAt', 'privileged', ];
...
bool? privileged,
  ...
  factory AppPassword.fromJson(Map<String, Object?> json) => _$AppPasswordFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'com.atproto.server.createAppPassword#appPassword'
;
}
