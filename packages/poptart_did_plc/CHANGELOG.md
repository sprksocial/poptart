...
- Repository metadata now points to `sprksocial/poptart`.
...
- **New Import Structure**: Single import `import 'package:poptart_did_plc/poptart_did_plc.dart';`
...
import 'package:poptart_did_plc/poptart_did_plc.dart' as plc;
...
2. **Imports**: Replace multiple imports with single `import 'package:poptart_did_plc/poptart_did_plc.dart';`
