...
abstract class ServerRefreshSessionOutput with _$ServerRefreshSessionOutput {
  static const knownProps = <String>['accessJwt', 'refreshJwt', 'handle', 'did', 'didDoc', 'email', 'emailConfirmed', 'emailAuthFactor', 'active', 'status', ];
...
@ServerRefreshSessionStatusConverter() ServerRefreshSessionStatus? status,
  ...
  factory ServerRefreshSessionOutput.fromJson(Map<String, Object?> json) => _$ServerRefreshSessionOutputFromJson(json);
}
