...
abstract class ServerCreateSessionInput with _$ServerCreateSessionInput {
  static const knownProps = <String>['identifier', 'password', 'authFactorToken', 'allowTakendown', ];
...
bool? allowTakendown,
  ...
  factory ServerCreateSessionInput.fromJson(Map<String, Object?> json) => _$ServerCreateSessionInputFromJson(json);
}
