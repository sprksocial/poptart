...
required String nsid,
  ...
  factory LexiconResolveLexiconInput.fromJson(Map<String, Object?> json) => _$LexiconResolveLexiconInputFromJson(json);
}
...
final class LexiconResolveLexiconInputConverter
  ...
  LexiconResolveLexiconInput fromJson(Map<String, dynamic> json) {
    return LexiconResolveLexiconInput.fromJson(translate(
      json,
      LexiconResolveLexiconInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(LexiconResolveLexiconInput object) => untranslate(
        object.toJson(),
      );
}
