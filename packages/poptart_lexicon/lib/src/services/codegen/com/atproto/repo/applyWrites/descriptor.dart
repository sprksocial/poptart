...
final createDescriptor = XRPCObjectDescriptor<Create>(
  ...
  defName: 'create',
  fromJson: (json) => const CreateConverter().fromJson(json.cast<String, dynamic>()),
...
final updateDescriptor = XRPCObjectDescriptor<Update>(
  nsid: 'com.atproto.repo.applyWrites',
  defName: 'update',
  fromJson: (json) => const UpdateConverter().fromJson(json.cast<String, dynamic>()),
...
final deleteDescriptor = XRPCObjectDescriptor<Delete>(
  nsid: 'com.atproto.repo.applyWrites',
  defName: 'delete',
  fromJson: (json) => const DeleteConverter().fromJson(json.cast<String, dynamic>()),
...
final createResultDescriptor = XRPCObjectDescriptor<CreateResult>(
  ...
  fromJson: (json) => const CreateResultConverter().fromJson(json.cast<String, dynamic>()),
...
final updateResultDescriptor = XRPCObjectDescriptor<UpdateResult>(
  ...
  fromJson: (json) => const UpdateResultConverter().fromJson(json.cast<String, dynamic>()),
...
final deleteResultDescriptor = XRPCObjectDescriptor<DeleteResult>(
  ...
  fromJson: (json) => const DeleteResultConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const DeleteResultConverter().toJson,
  matches: DeleteResult.validate,
);

final methodDescriptor = XRPCMethodDescriptor<EmptyData, RepoApplyWritesInput, RepoApplyWritesOutput>(
  nsid: NSID.parse('com.atproto.repo.applyWrites'),
  kind: XRPCMethodKind.procedure,  inputFromJson: (json) => const RepoApplyWritesInputConverter().fromJson(json.cast<String, dynamic>()),
  inputToJson: const RepoApplyWritesInputConverter().toJson,  outputFromJson: (json) => const RepoApplyWritesOutputConverter().fromJson(json.cast<String, dynamic>()),
