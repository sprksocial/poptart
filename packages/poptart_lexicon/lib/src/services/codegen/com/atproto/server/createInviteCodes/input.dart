...
@freezed
abstract class ServerCreateInviteCodesInput with _$ServerCreateInviteCodesInput {
...
List<String>? forAccounts,
  ...
  factory ServerCreateInviteCodesInput.fromJson(Map<String, Object?> json) => _$ServerCreateInviteCodesInputFromJson(json);
}
...
final class ServerCreateInviteCodesInputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerCreateInviteCodesInput object) => untranslate(
        object.toJson(),
      );
}
