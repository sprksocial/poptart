...
abstract class SyncGetRepoStatusStatus with _$SyncGetRepoStatusStatus {
  ...
  static SyncGetRepoStatusStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? SyncGetRepoStatusStatus.knownValue(data: knownValue) : SyncGetRepoStatusStatus.unknown(data: value);
  }
...
KnownSyncGetRepoStatusStatus? get knownValue => isKnownValue ? data as KnownSyncGetRepoStatusStatus : null;
...
final class SyncGetRepoStatusStatusConverter extends JsonConverter<SyncGetRepoStatusStatus, String> {
