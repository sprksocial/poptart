...
@RepoPutRecordValidationStatusConverter() RepoPutRecordValidationStatus? validationStatus,

    Map<String, dynamic>? $unknown,
  }) = _RepoPutRecordOutput;

  factory RepoPutRecordOutput.fromJson(Map<String, Object?> json) => _$RepoPutRecordOutputFromJson(json);
}
