...
abstract class RepoPutRecordInput with _$RepoPutRecordInput {
  static const knownProps = <String>['repo', 'collection', 'rkey', 'validate', 'record', 'swapRecord', 'swapCommit', ];
...
String? swapCommit,
  ...
  factory RepoPutRecordInput.fromJson(Map<String, Object?> json) => _$RepoPutRecordInputFromJson(json);
}
