...
abstract class RepoCreateRecordInput with _$RepoCreateRecordInput {
  static const knownProps = <String>['repo', 'collection', 'rkey', 'validate', 'record', 'swapCommit', ];
...
String? swapCommit,
  ...
  factory RepoCreateRecordInput.fromJson(Map<String, Object?> json) => _$RepoCreateRecordInputFromJson(json);
}
