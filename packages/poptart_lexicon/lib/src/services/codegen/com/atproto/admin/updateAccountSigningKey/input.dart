...
@freezed
abstract class AdminUpdateAccountSigningKeyInput with _$AdminUpdateAccountSigningKeyInput {
...
required String signingKey,
  ...
  factory AdminUpdateAccountSigningKeyInput.fromJson(Map<String, Object?> json) => _$AdminUpdateAccountSigningKeyInputFromJson(json);
}



final class AdminUpdateAccountSigningKeyInputConverter
    extends JsonConverter<AdminUpdateAccountSigningKeyInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(AdminUpdateAccountSigningKeyInput object) => untranslate(
        object.toJson(),
      );
}
