...
abstract class RepoDeleteRecordInput with _$RepoDeleteRecordInput {
  static const knownProps = <String>['repo', 'collection', 'rkey', 'swapRecord', 'swapCommit', ];
...
String? swapCommit,
  ...
  factory RepoDeleteRecordInput.fromJson(Map<String, Object?> json) => _$RepoDeleteRecordInputFromJson(json);
}
