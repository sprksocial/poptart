...
@freezed
abstract class IdentityResolveIdentityInput with _$IdentityResolveIdentityInput {
...
required String identifier,
  ...
  factory IdentityResolveIdentityInput.fromJson(Map<String, Object?> json) => _$IdentityResolveIdentityInputFromJson(json);
}
...
final class IdentityResolveIdentityInputConverter
  ...
  @override
  Map<String, dynamic> toJson(IdentityResolveIdentityInput object) => untranslate(
        object.toJson(),
      );
}
