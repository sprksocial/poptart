...
final labelDescriptor = XRPCObjectDescriptor<Label>(
  ...
  defName: 'label',
  fromJson: (json) => const LabelConverter().fromJson(json.cast<String, dynamic>()),
...
final selfLabelsDescriptor = XRPCObjectDescriptor<SelfLabels>(
  nsid: 'com.atproto.label.defs',
  defName: 'selfLabels',
  fromJson: (json) => const SelfLabelsConverter().fromJson(json.cast<String, dynamic>()),
...
final selfLabelDescriptor = XRPCObjectDescriptor<SelfLabel>(
  nsid: 'com.atproto.label.defs',
  defName: 'selfLabel',
  fromJson: (json) => const SelfLabelConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const SelfLabelConverter().toJson,
  matches: SelfLabel.validate,
);

final labelValueDefinitionDescriptor = XRPCObjectDescriptor<LabelValueDefinition>(
  nsid: 'com.atproto.label.defs',
  defName: 'labelValueDefinition',
  fromJson: (json) => const LabelValueDefinitionConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const LabelValueDefinitionConverter().toJson,
  matches: LabelValueDefinition.validate,
);

final labelValueDefinitionStringsDescriptor = XRPCObjectDescriptor<LabelValueDefinitionStrings>(
  nsid: 'com.atproto.label.defs',
  defName: 'labelValueDefinitionStrings',
  fromJson: (json) => const LabelValueDefinitionStringsConverter().fromJson(json.cast<String, dynamic>()),
