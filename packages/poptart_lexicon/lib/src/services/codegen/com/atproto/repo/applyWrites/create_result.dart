...
required String cid,
@CreateResultValidationStatusConverter() CreateResultValidationStatus? validationStatus,

    Map<String, dynamic>? $unknown,
  }) = _CreateResult;

  factory CreateResult.fromJson(Map<String, Object?> json) => _$CreateResultFromJson(json);
