...
abstract class ServerCreateAccountInput with _$ServerCreateAccountInput {
  static const knownProps = <String>['email', 'handle', 'did', 'inviteCode', 'verificationCode', 'verificationPhone', 'password', 'recoveryKey', 'plcOp', ];
...
Map<String, dynamic>? plcOp,
  ...
  factory ServerCreateAccountInput.fromJson(Map<String, Object?> json) => _$ServerCreateAccountInputFromJson(json);
}
