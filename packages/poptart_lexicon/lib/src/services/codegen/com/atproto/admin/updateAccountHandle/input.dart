...
@freezed
abstract class AdminUpdateAccountHandleInput with _$AdminUpdateAccountHandleInput {
...
required String handle,
  ...
  factory AdminUpdateAccountHandleInput.fromJson(Map<String, Object?> json) => _$AdminUpdateAccountHandleInputFromJson(json);
}
...
final class AdminUpdateAccountHandleInputConverter
  ...
  @override
  Map<String, dynamic> toJson(AdminUpdateAccountHandleInput object) => untranslate(
        object.toJson(),
      );
}
