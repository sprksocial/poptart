...
@freezed
sealed class UAdminGetSubjectStatusSubject with _$UAdminGetSubjectStatusSubject {
...
const factory UAdminGetSubjectStatusSubject.repoBlobRef({
  ...
  Map<String, dynamic> toJson() => const UAdminGetSubjectStatusSubjectConverter().toJson(this);
}

extension UAdminGetSubjectStatusSubjectExtension on UAdminGetSubjectStatusSubject {
...
bool get isRepoStrongRef => isA<UAdminGetSubjectStatusSubjectRepoStrongRef>(this);
...
final class UAdminGetSubjectStatusSubjectConverter implements JsonConverter<UAdminGetSubjectStatusSubject, Map<String, dynamic>> {
...
if (RepoBlobRef.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UAdminGetSubjectStatusSubject object) => object.when(
