...
const factory USyncSubscribeReposMessage.info({
  ...
  Map<String, dynamic> toJson() => const USyncSubscribeReposMessageConverter().toJson(this);
}
...
final class USyncSubscribeReposMessageConverter implements JsonConverter<USyncSubscribeReposMessage, Map<String, dynamic>> {
