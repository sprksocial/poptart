...
abstract class ServerDescribeServerOutput with _$ServerDescribeServerOutput {
  static const knownProps = <String>['inviteCodeRequired', 'phoneVerificationRequired', 'availableUserDomains', 'links', 'contact', 'did', ];
...
required String did,
  ...
  factory ServerDescribeServerOutput.fromJson(Map<String, Object?> json) => _$ServerDescribeServerOutputFromJson(json);
}
