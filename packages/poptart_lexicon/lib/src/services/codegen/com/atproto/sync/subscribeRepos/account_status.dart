...
abstract class AccountStatus with _$AccountStatus {
  ...
  static AccountStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? AccountStatus.knownValue(data: knownValue) : AccountStatus.unknown(data: value);
  }
...
KnownAccountStatus? get knownValue => isKnownValue ? data as KnownAccountStatus : null;
...
final class AccountStatusConverter extends JsonConverter<AccountStatus, String> {
