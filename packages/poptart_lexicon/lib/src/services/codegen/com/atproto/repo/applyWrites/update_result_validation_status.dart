...
@freezed
abstract class UpdateResultValidationStatus with _$UpdateResultValidationStatus {
  ...
  static UpdateResultValidationStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? UpdateResultValidationStatus.knownValue(data: knownValue) : UpdateResultValidationStatus.unknown(data: value);
  }

  String toJson() => const UpdateResultValidationStatusConverter().toJson(this);
}

extension UpdateResultValidationStatusExtension on UpdateResultValidationStatus {
  bool get isKnownValue => isA<UpdateResultValidationStatusKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownUpdateResultValidationStatus? get knownValue => isKnownValue ? data as KnownUpdateResultValidationStatus : null;
...
final class UpdateResultValidationStatusConverter extends JsonConverter<UpdateResultValidationStatus, String> {
