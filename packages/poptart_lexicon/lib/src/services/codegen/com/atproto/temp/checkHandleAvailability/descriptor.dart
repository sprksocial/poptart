...
final resultAvailableDescriptor = XRPCObjectDescriptor<ResultAvailable>(
  ...
  fromJson: (json) => const ResultAvailableConverter().fromJson(json.cast<String, dynamic>()),
...
final resultUnavailableDescriptor = XRPCObjectDescriptor<ResultUnavailable>(
  ...
  fromJson: (json) => const ResultUnavailableConverter().fromJson(json.cast<String, dynamic>()),
...
final methodDescriptor = XRPCMethodDescriptor<TempCheckHandleAvailabilityInput, EmptyData, TempCheckHandleAvailabilityOutput>(
  nsid: NSID.parse('com.atproto.temp.checkHandleAvailability'),
  kind: XRPCMethodKind.query,  parametersFromJson: (json) => const TempCheckHandleAvailabilityInputConverter().fromJson(json.cast<String, dynamic>()),
  parametersToJson: const TempCheckHandleAvailabilityInputConverter().toJson,  outputFromJson: (json) => const TempCheckHandleAvailabilityOutputConverter().fromJson(json.cast<String, dynamic>()),
