...
const factory URepoApplyWritesWrites.delete({
  ...
  Map<String, dynamic> toJson() => const URepoApplyWritesWritesConverter().toJson(this);
}
...
final class URepoApplyWritesWritesConverter implements JsonConverter<URepoApplyWritesWrites, Map<String, dynamic>> {
