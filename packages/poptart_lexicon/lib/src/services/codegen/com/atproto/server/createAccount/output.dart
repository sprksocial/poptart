...
abstract class ServerCreateAccountOutput with _$ServerCreateAccountOutput {
  static const knownProps = <String>['accessJwt', 'refreshJwt', 'handle', 'did', 'didDoc', ];
...
Map<String, dynamic>? didDoc,
  ...
  factory ServerCreateAccountOutput.fromJson(Map<String, Object?> json) => _$ServerCreateAccountOutputFromJson(json);
}
