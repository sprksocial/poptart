...
@freezed
abstract class ServerRequestEmailUpdateOutput with _$ServerRequestEmailUpdateOutput {
  ...
  factory ServerRequestEmailUpdateOutput.fromJson(Map<String, Object?> json) => _$ServerRequestEmailUpdateOutputFromJson(json);
}

extension ServerRequestEmailUpdateOutputExtension on ServerRequestEmailUpdateOutput {
...
final class ServerRequestEmailUpdateOutputConverter
    extends JsonConverter<ServerRequestEmailUpdateOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ServerRequestEmailUpdateOutput object) => untranslate(
        object.toJson(),
      );
}
