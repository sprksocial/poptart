...
const factory URepoApplyWritesResults.deleteResult({
  ...
  Map<String, dynamic> toJson() => const URepoApplyWritesResultsConverter().toJson(this);
}
...
final class URepoApplyWritesResultsConverter implements JsonConverter<URepoApplyWritesResults, Map<String, dynamic>> {
