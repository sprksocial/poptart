...
abstract class TempCheckSignupQueueOutput with _$TempCheckSignupQueueOutput {
  static const knownProps = <String>['activated', 'placeInQueue', 'estimatedTimeMs', ];
...
int? estimatedTimeMs,
  ...
  factory TempCheckSignupQueueOutput.fromJson(Map<String, Object?> json) => _$TempCheckSignupQueueOutputFromJson(json);
}
