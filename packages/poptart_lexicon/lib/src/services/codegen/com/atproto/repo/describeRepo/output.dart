...
abstract class RepoDescribeRepoOutput with _$RepoDescribeRepoOutput {
  static const knownProps = <String>['handle', 'did', 'didDoc', 'collections', 'handleIsCorrect', ];
...
required bool handleIsCorrect,
  ...
  factory RepoDescribeRepoOutput.fromJson(Map<String, Object?> json) => _$RepoDescribeRepoOutputFromJson(json);
}
