...
@freezed
abstract class ServerReserveSigningKeyOutput with _$ServerReserveSigningKeyOutput {
...
required String signingKey,
  ...
  factory ServerReserveSigningKeyOutput.fromJson(Map<String, Object?> json) => _$ServerReserveSigningKeyOutputFromJson(json);
}
...
final class ServerReserveSigningKeyOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerReserveSigningKeyOutput object) => untranslate(
        object.toJson(),
      );
}
