...
@freezed
abstract class ServerListAppPasswordsOutput with _$ServerListAppPasswordsOutput {
  ...
  factory ServerListAppPasswordsOutput.fromJson(Map<String, Object?> json) => _$ServerListAppPasswordsOutputFromJson(json);
}
...
final class ServerListAppPasswordsOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(ServerListAppPasswordsOutput object) => untranslate(
        object.toJson(),
      );
}
