...
;
  ...
  @override
  final String description = r"Get whether the requester and the other members can chat. If an existing convo is found for these members, it is returned.";

  @override
  final String invocation = "bsky chat-bsky-convo get-convo-availability [members]";
