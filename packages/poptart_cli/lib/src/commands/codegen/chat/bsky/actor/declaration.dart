...
final class _CreateDeclarationCommand extends CreateRecordCommand {
  _CreateDeclarationCommand() {
    argParser..addOption("allowIncoming",mandatory: true,)
..addOption("rkey")
;
  }
  ...
  @override
  final String description = r"Creates a new record for chat.bsky.actor.declaration.";

  @override
  final String invocation = "bsky chat-bsky-actor declaration create [allowIncoming] [rkey]";
...
;
  ...
  @override
  final String description = r"Updates a record for chat.bsky.actor.declaration.";

  @override
  final String invocation = "bsky chat-bsky-actor declaration put [allowIncoming] [rkey]";
...
final class _DeleteDeclarationCommand extends DeleteRecordCommand {
  ...
  @override
  final String description = r"Deletes a record for chat.bsky.actor.declaration.";
...
final class _ListDeclarationCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky chat-bsky-actor declaration list [limit] [cursor] [reverse]";
