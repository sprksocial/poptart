...
final class GetMessageContextCommand extends QueryCommand {
  GetMessageContextCommand() {
    argParser..addOption("convoId",help: r"Conversation that the message is from. NOTE: this field will eventually be required.",)
...
;
  ...
  @override
  final String invocation = "bsky chat-bsky-moderation get-message-context [convoId] [messageId] [before] [after]";
