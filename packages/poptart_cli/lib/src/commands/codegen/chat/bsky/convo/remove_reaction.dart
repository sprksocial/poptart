...
;
  ...
  @override
  final String description = r"Removes an emoji reaction from a message. Requires authentication. It is idempotent, so multiple calls from the same user with the same emoji result in that reaction not being present, even if it already wasn't.";

  @override
  final String invocation = "bsky chat-bsky-convo remove-reaction [convoId] [messageId] [value]";
