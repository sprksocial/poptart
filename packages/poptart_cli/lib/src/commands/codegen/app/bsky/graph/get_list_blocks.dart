...
;
  ...
  @override
  final String description = r"Get mod lists that the requesting account (actor) is blocking. Requires auth.";

  @override
  final String invocation = "bsky app-bsky-graph get-list-blocks [limit] [cursor]";
