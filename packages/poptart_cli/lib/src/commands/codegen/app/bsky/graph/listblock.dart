...
final class ListblockCommand extends Command<void> {
  ...
  @override
  String get description => "Record representing a block relationship against an entire an entire list of accounts (actors).";
}

final class _CreateListblockCommand extends CreateRecordCommand {
  _CreateListblockCommand() {
    argParser..addOption("subject",help: r"Reference (AT-URI) to the mod list record.",mandatory: true,)
...
;
  ...
  @override
  final String description = r"Creates a new record for app.bsky.graph.listblock.";

  @override
  final String invocation = "bsky app-bsky-graph listblock create [subject] [createdAt] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph listblock put [subject] [createdAt] [rkey]";
...
final class _ListListblockCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph listblock list [limit] [cursor] [reverse]";
