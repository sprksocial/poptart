...
;
  ...
  @override
  final String description = r"Find actor suggestions for a prefix search term. Expected use is for auto-completion during text field entry. Does not require auth.";

  @override
  final String invocation = "bsky app-bsky-actor search-actors-typeahead [term] [q] [limit]";
