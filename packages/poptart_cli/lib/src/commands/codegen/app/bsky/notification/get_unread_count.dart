...
;
  ...
  @override
  final String description = r"Count the number of unread notifications for the requesting account. Requires auth.";

  @override
  final String invocation = "bsky app-bsky-notification get-unread-count [priority] [seenAt]";
