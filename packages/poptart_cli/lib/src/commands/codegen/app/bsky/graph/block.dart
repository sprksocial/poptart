...
final class BlockCommand extends Command<void> {
  ...
  @override
  String get description => "Record declaring a 'block' relationship against another account. NOTE: blocks are public in Bluesky; see blog posts for details.";
}

final class _CreateBlockCommand extends CreateRecordCommand {
  _CreateBlockCommand() {
    argParser..addOption("subject",help: r"DID of the account to be blocked.",mandatory: true,)
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph block create [subject] [createdAt] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph block put [subject] [createdAt] [rkey]";
...
final class _ListBlockCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph block list [limit] [cursor] [reverse]";
