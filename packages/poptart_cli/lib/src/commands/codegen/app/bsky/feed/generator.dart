...
final class GeneratorCommand extends Command<void> {
  ...
  @override
  String get description => "Record declaring of the existence of a feed generator, and containing metadata about it. The record can exist in any repository.";
}
...
..addOption("avatar",)
..addFlag("acceptsInteractions",help: r"Declaration that a feed accepts feedback interactions from a client through app.bsky.feed.sendInteractions",)
...
;
  ...
  @override
  final String description = r"Creates a new record for app.bsky.feed.generator.";

  @override
  final String invocation = "bsky app-bsky-feed generator create [did] [displayName] [description] [descriptionFacets] [avatar] [acceptsInteractions] [labels] [contentMode] [createdAt] [rkey]";
...
if (argResults!["descriptionFacets"] != null)"descriptionFacets": argResults!["descriptionFacets"],
if (argResults!["avatar"] != null)"avatar": argResults!["avatar"],
if (argResults!["acceptsInteractions"] != null)"acceptsInteractions": argResults!["acceptsInteractions"],
if (argResults!["labels"] != null)"labels": jsonDecode(argResults!["labels"]),
if (argResults!["contentMode"] != null)"contentMode": argResults!["contentMode"],
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed generator put [did] [displayName] [description] [descriptionFacets] [avatar] [acceptsInteractions] [labels] [contentMode] [createdAt] [rkey]";
...
final class _ListGeneratorCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed generator list [limit] [cursor] [reverse]";
