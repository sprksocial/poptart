...
final class ThreadgateCommand extends Command<void> {
  ...
  @override
  String get description => "Record defining interaction gating rules for a thread (aka, reply controls). The record key (rkey) of the threadgate record must match the record key of the thread's root post, and that record must be in the same repository.";
}

final class _CreateThreadgateCommand extends CreateRecordCommand {
  _CreateThreadgateCommand() {
    argParser..addOption("post",help: r"Reference (AT-URI) to the post record.",mandatory: true,)
..addMultiOption("allow",help: r"List of rules defining who can reply to this post. If value is an empty array, no one can reply. If value is undefined, anyone can reply.",)
...
;
  ...
  @override
  final String description = r"Creates a new record for app.bsky.feed.threadgate.";

  @override
  final String invocation = "bsky app-bsky-feed threadgate create [post] [allow] [createdAt] [hiddenReplies] [rkey]";
...
if (argResults!["hiddenReplies"] != null)"hiddenReplies": argResults!["hiddenReplies"],
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed threadgate put [post] [allow] [createdAt] [hiddenReplies] [rkey]";
...
final class _ListThreadgateCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed threadgate list [limit] [cursor] [reverse]";
