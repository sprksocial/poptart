...
final class _CreatePostCommand extends CreateRecordCommand {
  _CreatePostCommand() {
    argParser..addOption("text",help: r"The primary post content. May be an empty string, if there are embeds.",mandatory: true,)
..addMultiOption("entities",help: r"DEPRECATED: replaced by app.bsky.richtext.facet.",)
..addMultiOption("facets",help: r"Annotations of text (mentions, URLs, hashtags, etc)",)
..addOption("reply",)
..addOption("embed",)
..addMultiOption("langs",help: r"Indicates human language of post primary text content.",)
..addOption("labels",help: r"Self-label values for this post. Effectively content warnings.",)
..addMultiOption("tags",help: r"Additional hashtags, in addition to any included in post text and facets.",)
..addOption("createdAt",help: r"Client-declared timestamp when this post was originally created.",mandatory: true,)
..addOption("rkey")
;
  }
  ...
  @override
  final String invocation = "bsky app-bsky-feed post create [text] [entities] [facets] [reply] [embed] [langs] [labels] [tags] [createdAt] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed post put [text] [entities] [facets] [reply] [embed] [langs] [labels] [tags] [createdAt] [rkey]";
...
final class _ListPostCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed post list [limit] [cursor] [reverse]";
