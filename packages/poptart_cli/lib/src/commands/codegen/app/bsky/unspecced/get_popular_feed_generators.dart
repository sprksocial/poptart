...
;
  ...
  @override
  final String description = r"An unspecced view of globally popular feed generators.";

  @override
  final String invocation = "bsky app-bsky-unspecced get-popular-feed-generators [limit] [cursor] [query]";
