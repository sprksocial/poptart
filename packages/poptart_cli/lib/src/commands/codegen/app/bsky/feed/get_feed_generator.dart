...
final class GetFeedGeneratorCommand extends QueryCommand {
  GetFeedGeneratorCommand() {
    argParser..addOption("feed",help: r"AT-URI of the feed generator record.",mandatory: true,)
;
  }
  ...
  @override
  final String description = r"Get information about a feed generator. Implemented by AppView.";
