...
final class PostgateCommand extends Command<void> {
  ...
  @override
  String get description => "Record defining interaction rules for a post. The record key (rkey) of the postgate record must match the record key of the post, and that record must be in the same repository.";
}

final class _CreatePostgateCommand extends CreateRecordCommand {
  _CreatePostgateCommand() {
    argParser..addOption("createdAt",mandatory: true,)
..addOption("post",help: r"Reference (AT-URI) to the post record.",mandatory: true,)
..addMultiOption("detachedEmbeddingUris",help: r"List of AT-URIs embedding this post that the author has detached from.",)
..addMultiOption("embeddingRules",help: r"List of rules defining who can embed this post. If value is an empty array or is undefined, no particular rules apply and anyone can embed.",)
..addOption("rkey")
;
  }
  ...
  @override
  final String description = r"Creates a new record for app.bsky.feed.postgate.";

  @override
  final String invocation = "bsky app-bsky-feed postgate create [createdAt] [post] [detachedEmbeddingUris] [embeddingRules] [rkey]";
...
if (argResults!["detachedEmbeddingUris"] != null)"detachedEmbeddingUris": argResults!["detachedEmbeddingUris"],
if (argResults!["embeddingRules"] != null)"embeddingRules": argResults!["embeddingRules"],
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed postgate put [createdAt] [post] [detachedEmbeddingUris] [embeddingRules] [rkey]";
...
final class _ListPostgateCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed postgate list [limit] [cursor] [reverse]";
