...
;
  ...
  @override
  final String description = r"Creates a private bookmark for the specified record. Currently, only `app.bsky.feed.post` records are supported. Requires authentication.";

  @override
  final String invocation = "bsky app-bsky-bookmark create-bookmark [uri] [cid]";
