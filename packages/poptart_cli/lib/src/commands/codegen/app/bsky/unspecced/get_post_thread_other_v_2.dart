...
final class GetPostThreadOtherV2Command extends QueryCommand {
  GetPostThreadOtherV2Command() {
    argParser..addOption("anchor",help: r"Reference (AT-URI) to post record. This is the anchor post.",mandatory: true,)
;
  }
  ...
  @override
  final String invocation = "bsky app-bsky-unspecced get-post-thread-other-v-2 [anchor]";
