...
final class _CreateStatusCommand extends CreateRecordCommand {
  _CreateStatusCommand() {
    argParser..addOption("status",help: r"The status for the account.",mandatory: true,)
..addOption("embed",help: r"An optional embed associated with the status.",)
..addOption("durationMinutes",help: r"The duration of the status in minutes. Applications can choose to impose minimum and maximum limits.",)
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-actor status create [status] [embed] [durationMinutes] [createdAt] [rkey]";
...
if (argResults!["durationMinutes"] != null)"durationMinutes": argResults!["durationMinutes"],
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-actor status put [status] [embed] [durationMinutes] [createdAt] [rkey]";
...
final class _ListStatusCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-actor status list [limit] [cursor] [reverse]";
