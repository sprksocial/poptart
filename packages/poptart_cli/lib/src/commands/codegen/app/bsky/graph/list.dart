...
final class ListCommand extends Command<void> {
  ...
  @override
  String get description => "Record representing a list of accounts (actors). Scope includes both moderation-oriented lists and curration-oriented lists.";
}

final class _CreateListCommand extends CreateRecordCommand {
  _CreateListCommand() {
    argParser..addOption("purpose",help: r"Defines the purpose of the list (aka, moderation-oriented or curration-oriented)",mandatory: true,)
..addOption("name",help: r"Display name for list; can not be empty.",mandatory: true,)
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph list create [purpose] [name] [description] [descriptionFacets] [avatar] [labels] [createdAt] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph list put [purpose] [name] [description] [descriptionFacets] [avatar] [labels] [createdAt] [rkey]";
...
final class _ListListCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph list list [limit] [cursor] [reverse]";
