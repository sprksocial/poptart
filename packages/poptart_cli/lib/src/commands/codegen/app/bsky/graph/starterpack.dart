...
final class StarterpackCommand extends Command<void> {
  ...
  @override
  String get description => "Record defining a starter pack of actors and feeds for new users.";
}

final class _CreateStarterpackCommand extends CreateRecordCommand {
  _CreateStarterpackCommand() {
    argParser..addOption("name",help: r"Display name for starter pack; can not be empty.",mandatory: true,)
..addOption("description",)
..addMultiOption("descriptionFacets",)
..addOption("list",help: r"Reference (AT-URI) to the list record.",mandatory: true,)
...
;
  ...
  @override
  final String description = r"Creates a new record for app.bsky.graph.starterpack.";

  @override
  final String invocation = "bsky app-bsky-graph starterpack create [name] [description] [descriptionFacets] [list] [feeds] [createdAt] [rkey]";
...
;
  ...
  @override
  final String description = r"Updates a record for app.bsky.graph.starterpack.";

  @override
  final String invocation = "bsky app-bsky-graph starterpack put [name] [description] [descriptionFacets] [list] [feeds] [createdAt] [rkey]";
...
final class _DeleteStarterpackCommand extends DeleteRecordCommand {
  ...
  @override
  final String description = r"Deletes a record for app.bsky.graph.starterpack.";
...
final class _ListStarterpackCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph starterpack list [limit] [cursor] [reverse]";
