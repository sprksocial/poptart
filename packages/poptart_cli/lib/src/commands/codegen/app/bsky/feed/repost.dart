...
final class RepostCommand extends Command<void> {
  ...
  @override
  String get description => "Record representing a 'repost' of an existing Bluesky post.";
}
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed repost create [subject] [createdAt] [via] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed repost put [subject] [createdAt] [via] [rkey]";
...
final class _ListRepostCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed repost list [limit] [cursor] [reverse]";
