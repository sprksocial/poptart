...
final class ListitemCommand extends Command<void> {
  ...
  @override
  String get description => "Record representing an account's inclusion on a specific list. The AppView will ignore duplicate listitem records.";
}

final class _CreateListitemCommand extends CreateRecordCommand {
  _CreateListitemCommand() {
    argParser..addOption("subject",help: r"The account which is included on the list.",mandatory: true,)
..addOption("list",help: r"Reference (AT-URI) to the list record (app.bsky.graph.list).",mandatory: true,)
...
;
  ...
  @override
  final String description = r"Creates a new record for app.bsky.graph.listitem.";

  @override
  final String invocation = "bsky app-bsky-graph listitem create [subject] [list] [createdAt] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph listitem put [subject] [list] [createdAt] [rkey]";
...
final class _ListListitemCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph listitem list [limit] [cursor] [reverse]";
