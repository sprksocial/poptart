...
final class ListNotificationsCommand extends QueryCommand {
  ListNotificationsCommand() {
    argParser..addMultiOption("reasons",help: r"Notification reasons to include in response.",)
...
;
  ...
  @override
  final String description = r"Enumerate notifications for the requesting account. Requires auth.";

  @override
  final String invocation = "bsky app-bsky-notification list-notifications [reasons] [limit] [priority] [cursor] [seenAt]";
