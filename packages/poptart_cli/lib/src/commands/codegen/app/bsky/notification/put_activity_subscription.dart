...
;
  ...
  @override
  final String description = r"Puts an activity subscription entry. The key should be omitted for creation and provided for updates. Requires auth.";

  @override
  final String invocation = "bsky app-bsky-notification put-activity-subscription [subject] [activitySubscription]";
