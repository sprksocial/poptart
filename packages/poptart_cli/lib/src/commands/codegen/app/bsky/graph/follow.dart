...
final class FollowCommand extends Command<void> {
  ...
  @override
  String get description => "Record declaring a social 'follow' relationship of another account. Duplicate follows will be ignored by the AppView.";
}

final class _CreateFollowCommand extends CreateRecordCommand {
  _CreateFollowCommand() {
    argParser..addOption("subject",mandatory: true,)
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph follow create [subject] [createdAt] [via] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-graph follow put [subject] [createdAt] [via] [rkey]";
...
final class _ListFollowCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-graph follow list [limit] [cursor] [reverse]";
