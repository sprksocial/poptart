...
;
  ...
  @override
  final String description = r"Enumerate all accounts to which the requesting account is subscribed to receive notifications for. Requires auth.";

  @override
  final String invocation = "bsky app-bsky-notification list-activity-subscriptions [limit] [cursor]";
