...
final class GetAgeAssuranceStateCommand extends QueryCommand {
  ...
  @override
  final String description = r"Returns the current state of the age assurance process for an account. This is used to check if the user has completed age assurance or if further action is required.";
