...
final class LikeCommand extends Command<void> {
  ...
  @override
  String get description => "Record declaring a 'like' of a piece of subject content.";
}
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed like create [subject] [createdAt] [via] [rkey]";
...
;
  ...
  @override
  final String invocation = "bsky app-bsky-feed like put [subject] [createdAt] [via] [rkey]";
...
final class _ListLikeCommand extends QueryCommand {
  ...
  @override
  final String invocation = "bsky app-bsky-feed like list [limit] [cursor] [reverse]";
