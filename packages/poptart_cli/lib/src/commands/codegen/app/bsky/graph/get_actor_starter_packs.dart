...
;
  ...
  @override
  final String description = r"Get a list of starter packs created by the actor.";

  @override
  final String invocation = "bsky app-bsky-graph get-actor-starter-packs [actor] [limit] [cursor]";
