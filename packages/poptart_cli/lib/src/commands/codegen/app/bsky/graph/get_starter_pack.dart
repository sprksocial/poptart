...
final class GetStarterPackCommand extends QueryCommand {
  GetStarterPackCommand() {
    argParser..addOption("starterPack",help: r"Reference (AT-URI) of the starter pack record.",mandatory: true,)
;
  }
  ...
  @override
  final String invocation = "bsky app-bsky-graph get-starter-pack [starterPack]";
