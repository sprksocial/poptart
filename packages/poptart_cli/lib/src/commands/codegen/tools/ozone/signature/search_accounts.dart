...
;
  ...
  @override
  final String description = r"Search for accounts that match one or more threat signature values.";

  @override
  final String invocation = "bsky tools-ozone-signature search-accounts [values] [cursor] [limit]";
