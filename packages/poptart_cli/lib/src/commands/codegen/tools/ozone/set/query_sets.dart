...
..addOption("sortDirection",help: r"Defaults to ascending order of name field.",defaultsTo: "asc",)
;
  }
  ...
  @override
  final String invocation = "bsky tools-ozone-set query-sets [limit] [cursor] [namePrefix] [sortBy] [sortDirection]";
...
if (argResults!["namePrefix"] != null)"namePrefix": argResults!["namePrefix"],
