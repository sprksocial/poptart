...
final class UpsertOptionCommand extends ProcedureCommand {
  UpsertOptionCommand() {
    argParser..addOption("key",mandatory: true,)
...
;
  ...
  @override
  final String invocation = "bsky tools-ozone-setting upsert-option [key] [scope] [value] [description] [managerRole]";
...
if (argResults!["managerRole"] != null)"managerRole": argResults!["managerRole"],
