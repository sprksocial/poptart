...
final class QueryRulesCommand extends ProcedureCommand {
  QueryRulesCommand() {
    argParser..addOption("cursor",help: r"Cursor for pagination",)
...
;
  ...
  @override
  final String invocation = "bsky tools-ozone-safelink query-rules [cursor] [limit] [urls] [patternType] [actions] [reason] [createdBy] [sortDirection]";
...
if (argResults!["patternType"] != null)"patternType": argResults!["patternType"],
