...
final class AddRuleCommand extends ProcedureCommand {
  AddRuleCommand() {
    argParser..addOption("url",help: r"The URL or domain to apply the rule to",mandatory: true,)
...
..addOption("createdBy",help: r"Author DID. Only respected when using admin auth",)
;
  }
  ...
  @override
  final String invocation = "bsky tools-ozone-safelink add-rule [url] [pattern] [action] [reason] [comment] [createdBy]";
