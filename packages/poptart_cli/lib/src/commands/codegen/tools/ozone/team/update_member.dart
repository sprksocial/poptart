...
;
  ...
  @override
  final String description = r"Update a member in the ozone service. Requires admin role.";

  @override
  final String invocation = "bsky tools-ozone-team update-member [did] [disabled] [role]";
