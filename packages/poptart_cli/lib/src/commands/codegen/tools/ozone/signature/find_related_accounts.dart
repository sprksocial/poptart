...
;
  ...
  @override
  final String description = r"Get accounts that share some matching threat signatures with the root account.";

  @override
  final String invocation = "bsky tools-ozone-signature find-related-accounts [did] [cursor] [limit]";
