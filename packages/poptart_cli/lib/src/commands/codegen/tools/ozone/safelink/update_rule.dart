...
final class UpdateRuleCommand extends ProcedureCommand {
  UpdateRuleCommand() {
    argParser..addOption("url",help: r"The URL or domain to update the rule for",mandatory: true,)
...
..addOption("createdBy",help: r"Optional DID to credit as the creator. Only respected for admin_token authentication.",)
;
  }
  ...
  @override
  final String invocation = "bsky tools-ozone-safelink update-rule [url] [pattern] [action] [reason] [comment] [createdBy]";
