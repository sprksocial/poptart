...
..addMultiOption("keys",help: r"Filter for only the specified keys. Ignored if prefix is provided",)
;
  }
  ...
  @override
  final String invocation = "bsky tools-ozone-setting list-options [limit] [cursor] [scope] [prefix] [keys]";
