...
;
  ...
  @override
  final String description = r"Find all correlated threat signatures between 2 or more accounts.";

  @override
  final String invocation = "bsky tools-ozone-signature find-correlation [dids]";
