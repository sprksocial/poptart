...
;
  ...
  @override
  final String description = r"Disable an account from receiving new invite codes, but does not invalidate existing codes.";

  @override
  final String invocation = "bsky com-atproto-admin disable-account-invites [account] [note]";
