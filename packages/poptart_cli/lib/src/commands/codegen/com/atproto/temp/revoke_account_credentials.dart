...
;
  ...
  @override
  final String description = r"Revoke sessions, password, and app passwords associated with account. May be resolved by a password reset.";

  @override
  final String invocation = "bsky com-atproto-temp revoke-account-credentials [account]";
