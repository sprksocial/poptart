...
;
  ...
  @override
  final String description = r"Request a verification code to be sent to the supplied phone number";

  @override
  final String invocation = "bsky com-atproto-temp request-phone-verification [phoneNumber]";
