...
..addOption("signingKey",help: r"Did-key formatted public key",mandatory: true,)
;
  }
  ...
  @override
  final String description = r"Administrative action to update an account's signing key in their Did document.";

  @override
  final String invocation = "bsky com-atproto-admin update-account-signing-key [did] [signingKey]";
