...
;
  ...
  @override
  final String description = r"Update the password for a user account as an administrator.";

  @override
  final String invocation = "bsky com-atproto-admin update-account-password [did] [password]";
