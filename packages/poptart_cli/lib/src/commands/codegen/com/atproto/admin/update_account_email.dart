...
final class UpdateAccountEmailCommand extends ProcedureCommand {
  UpdateAccountEmailCommand() {
    argParser..addOption("account",help: r"The handle or DID of the repo.",mandatory: true,)
...
;
  ...
  @override
  final String description = r"Administrative action to update an account's email.";

  @override
  final String invocation = "bsky com-atproto-admin update-account-email [account] [email]";
