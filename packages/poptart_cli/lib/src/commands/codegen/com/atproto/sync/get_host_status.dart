...
final class GetHostStatusCommand extends QueryCommand {
  GetHostStatusCommand() {
    argParser..addOption("hostname",help: r"Hostname of the host (eg, PDS or relay) being queried.",mandatory: true,)
;
  }
  ...
  @override
  final String description = r"Returns information about a specified upstream host, as consumed by the server. Implemented by relays.";
