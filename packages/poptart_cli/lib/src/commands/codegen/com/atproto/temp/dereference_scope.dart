...
final class DereferenceScopeCommand extends QueryCommand {
  DereferenceScopeCommand() {
    argParser..addOption("scope",help: r"The scope reference (starts with 'ref:')",mandatory: true,)
;
  }
  ...
  @override
  final String description = r"Allows finding the oauth permission scope from a reference";
