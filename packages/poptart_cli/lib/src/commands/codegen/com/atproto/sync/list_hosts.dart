...
final class ListHostsCommand extends QueryCommand {
  ListHostsCommand() {
    argParser..addOption("limit",defaultsTo: "200",)
..addOption("cursor",)
;
  }
  ...
  @override
  final String description = r"Enumerates upstream hosts (eg, PDS or relay instances) that this service consumes from. Implemented by relays.";
