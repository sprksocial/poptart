...
;
  ...
  @override
  final String description = r"Initiate a user account password reset via email.";

  @override
  final String invocation = "bsky com-atproto-server request-password-reset [email]";
