...
;
  ...
  @override
  final String description = r"Re-enable an account's ability to receive invite codes.";

  @override
  final String invocation = "bsky com-atproto-admin enable-account-invites [account] [note]";
