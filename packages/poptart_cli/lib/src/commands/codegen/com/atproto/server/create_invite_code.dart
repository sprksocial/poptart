...
final class CreateInviteCodeCommand extends ProcedureCommand {
  CreateInviteCodeCommand() {
    argParser..addOption("useCount",mandatory: true,)
...
;
  ...
  @override
  final String invocation = "bsky com-atproto-server create-invite-code [useCount] [forAccount]";
...
if (argResults!["forAccount"] != null)"forAccount": argResults!["forAccount"],
