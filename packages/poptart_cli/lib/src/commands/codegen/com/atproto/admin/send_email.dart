...
final class SendEmailCommand extends ProcedureCommand {
  SendEmailCommand() {
    argParser..addOption("recipientDid",mandatory: true,)
..addOption("content",mandatory: true,)
..addOption("subject",)
..addOption("senderDid",mandatory: true,)
..addOption("comment",help: r"Additional comment by the sender that won't be used in the email itself but helpful to provide more context for moderators/reviewers",)
;
  }
  ...
  @override
  final String invocation = "bsky com-atproto-admin send-email [recipientDid] [content] [subject] [senderDid] [comment]";
