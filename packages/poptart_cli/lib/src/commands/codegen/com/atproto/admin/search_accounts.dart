...
;
  ...
  @override
  final String description = r"Get list of accounts that matches your search query.";

  @override
  final String invocation = "bsky com-atproto-admin search-accounts [email] [cursor] [limit]";
