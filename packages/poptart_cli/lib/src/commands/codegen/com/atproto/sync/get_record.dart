...
;
  ...
  @override
  final String description = r"Get data blocks needed to prove the existence or non-existence of record in the current version of repo. Does not require auth.";

  @override
  final String invocation = "bsky com-atproto-sync get-record [did] [collection] [rkey]";
