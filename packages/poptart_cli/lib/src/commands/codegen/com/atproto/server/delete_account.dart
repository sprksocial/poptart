...
;
  ...
  @override
  final String description = r"Delete an actor's account with a token and password. Can only be called after requesting a deletion token. Requires auth.";

  @override
  final String invocation = "bsky com-atproto-server delete-account [did] [password] [token]";
