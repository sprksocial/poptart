...
final class ResolveHandleCommand extends QueryCommand {
  ResolveHandleCommand() {
    argParser..addOption("handle",help: r"The handle to resolve.",mandatory: true,)
;
  }
  ...
  @override
  final String description = r"Resolves an atproto handle (hostname) to a DID. Does not necessarily bi-directionally verify against the the DID document.";
