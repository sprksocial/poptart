...
;
  ...
  @override
  final String description = r"Disable some set of codes and/or all codes associated with a set of users.";

  @override
  final String invocation = "bsky com-atproto-admin disable-invite-codes [codes] [accounts]";
