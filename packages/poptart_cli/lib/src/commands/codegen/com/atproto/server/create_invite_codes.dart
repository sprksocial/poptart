...
;
  ...
  @override
  final String invocation = "bsky com-atproto-server create-invite-codes [codeCount] [useCount] [forAccounts]";
...
if (argResults!["forAccounts"] != null)"forAccounts": argResults!["forAccounts"],
