...
;
  ...
  @override
  final String description = r"Administrative action to update an account's handle.";

  @override
  final String invocation = "bsky com-atproto-admin update-account-handle [did] [handle]";
